        ...
        <>
            <div className="bg-slate-300 w-full min-h-screen">
                <div className="w-full h-96 flex flex-col items-center justify-center relative">
                    ...
                    <svg className="absolute bottom-[92px] right-[280px]" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#525252" viewBox="0 0 256 256"><path d="M228.24,219.76l-51.38-51.38a86.15,86.15,0,1,0-8.48,8.48l51.38,51.38a6,6,0,0,0,8.48-8.48ZM38,112a74,74,0,1,1,74,74A74.09,74.09,0,0,1,38,112Z"></path></svg>
                </div>
